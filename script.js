...
const pages = [
    `Emperor Malachior VII adalah penguasa saat ini di era Open Source. Ia dikenal sebagai pemimpin yang inovatif dan terbuka terhadap perubahan. Di bawah kepemimpinannya, kerajaan mengalami kemajuan pesat dalam teknologi dan kolaborasi antar rakyat.`,
    `Malachior VII mendorong semua warga untuk berbagi ilmu dan sumber daya. Ia percaya bahwa kekuatan terbesar kerajaan terletak pada kebersamaan dan keterbukaan. Banyak proyek besar berhasil karena semangat gotong royong yang ia tanamkan.`,
    `Di masa pemerintahannya, akses informasi menjadi hak semua orang. Malachior VII menghapus batasan-batasan lama dan membangun sistem yang transparan. Rakyat merasa lebih didengar dan dilibatkan dalam pengambilan keputusan penting.`,
    `Walau menghadapi tantangan dari pihak konservatif, Malachior VII tetap teguh pada visinya. Ia mengajak semua golongan untuk beradaptasi dan belajar bersama. Kerajaan pun semakin dihormati oleh negeri-negeri tetangga.`,
    `Emperor Malachior VII akan selalu dikenang sebagai simbol perubahan dan kemajuan. Kepemimpinannya di era Open Source menjadi inspirasi bagi generasi berikutnya untuk terus berinovasi dan menjaga semangat kolaborasi.`,
];
...
const noblesData = {
    "the-wild-world-era": {
        description: `
      Era ini adalah awal mula kekuasaan besar. 
      The Wild World Era adalah masa awal berdirinya kerajaan, 
      ketika dunia masih liar dan penuh misteri. 
      Pada era ini, para pendiri kerajaan berjuang menaklukkan alam dan membangun fondasi peradaban. 
      Segala sesuatu dimulai dari ketidakpastian, 
      namun semangat persatuan dan keberanian membawa kerajaan menuju masa depan yang lebih cerah.
    `,
        nobles: [
            { name: "Arkanos the Wild", img: "assets/contents/noble-king.png" },
            { name: "Lady Ferina", img: "assets/contents/noble-king 1.png" },
            { name: "General Balt", img: "assets/contents/noble-king 2.png" },
        ],
    },
    "the-first-mother-era": {
        description: `
      Pada masa ini, para ibu agung memimpin peradaban. Mereka dikenal sebagai pelindung, pengasuh, dan
                      sumber kebijaksanaan bagi seluruh kerajaan. Di bawah kepemimpinan mereka, masyarakat berkembang
                      dengan nilai kasih sayang, gotong royong, dan penghormatan terhadap tradisi. Era ini juga ditandai
                      dengan kemajuan dalam seni, pendidikan, dan tata kelola, menjadikan kerajaan semakin makmur dan
                      harmonis.
    `,
        nobles: [
            { name: "Mother Sylvara", img: "assets/contents/noble-king 3.png" },
            { name: "Elder Numea", img: "assets/contents/noble-king 4.png" },
        ],
    },
    "the-black-boss-era": {
        description: `
      Kekuasaan gelap merajai. Pada era ini, kerajaan dipimpin oleh sosok misterius yang dikenal
                      sebagai The Black Boss, membawa perubahan besar dan penuh tantangan. Intrik, strategi, dan
                      kekuatan menjadi kunci bertahan hidup. Masyarakat hidup dalam bayang-bayang ketakutan, namun dari
                      kegelapan inilah muncul harapan baru dan tekad untuk membangun masa depan yang lebih baik.
    `,
        nobles: [
            { name: "Lord Umbrax", img: "assets/contents/noble-king 5.png" },
            { name: "Duke Renvar", img: "assets/contents/noble-king 6.png" },
            { name: "Mistress Vharra", img: "assets/contents/noble-king 7.png" },
            { name: "Captain Xeros", img: "assets/contents/noble-king 9.png" },
        ],
    },
    "the-pandemic-era": {
        description: `
      Bencana besar menyebar ke seluruh negeri. Pada masa The Pandemic Era, kerajaan menghadapi
                      tantangan yang belum pernah terjadi sebelumnya. Wabah misterius memaksa semua rakyat untuk
                      beradaptasi, saling menjaga jarak, dan menemukan cara baru untuk bertahan hidup. Di tengah
                      keterbatasan, muncul solidaritas dan inovasi, memperkuat ikatan antar warga serta menumbuhkan
                      harapan akan masa depan yang lebih baik.
    `,
        nobles: [{ name: "Healer Orion", img: "assets/contents/noble-king 8.png" }],
    },
    "the-open-source-era": {
        description: `
      Semua orang memiliki kekuatan yang setara. Pada The Open Source Era, pengetahuan dan inovasi
                      dibagikan secara bebas tanpa batasan. Setiap individu berkontribusi untuk kemajuan bersama,
                      membangun komunitas yang saling mendukung dan terbuka terhadap perubahan. Kolaborasi menjadi kunci
                      utama, mendorong terciptanya solusi kreatif dan teknologi baru yang bermanfaat bagi seluruh
                      kerajaan. Era ini menandai kebangkitan semangat gotong royong dan transparansi, di mana setiap
                      suara dihargai dan setiap ide dapat mengubah masa depan.
    `,
        nobles: [
            { name: "Chancellor Freon", img: "assets/contents/noble-king 11.png" },
            { name: "Archivist Vela and The Monx", img: "assets/contents/noble-king 12.png" },
        ],
    },
};
